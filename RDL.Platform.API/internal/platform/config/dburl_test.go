...
func TestPoolerURLAcceptsHostOrFullConnectionString(t *testing.T) {
	want := "postgres://platform_api.abcref@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require"
	for _, host := range []string{
		"aws-0-us-east-1.pooler.supabase.com",
		"  aws-0-us-east-1.pooler.supabase.com  ",
		"postgresql://postgres.abcref:[YOUR-PASSWORD]@aws-0-us-east-1.pooler.supabase.com:5432/postgres",
	} {
		got, err := PoolerURL("https://abcref.supabase.co", host, "platform_api", PoolerTransactionPort)
		if err != nil || got != want {
...
func TestPoolerURLRequiresHost(t *testing.T) {
	if _, err := PoolerURL("https://abcref.supabase.co", "", "platform_api", PoolerTransactionPort); err == nil {
...
func TestLoadBuildsDatabaseURLFromPoolerHost(t *testing.T) {
	...
	if cfg.DB.URL != "postgres://platform_api.abcref@aws-0-us-east-1.pooler.supabase.com:6543/postgres?sslmode=require" {
